...
LarliteRecordComposer::LarliteRecordComposer(JsonObject& output, TFile* file, Long64_t jentry, const std::string options)
  : fOutput(output), fFile(file), fEntry(jentry), fOptions(options)
{
