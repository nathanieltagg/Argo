...
class AnaRecordComposer : public Composer {};
...
// VoidFuncPtr_t myinitfuncs[] = { 0 };
// TROOT groot("Rint", "The ROOT Interactive Interface", myinitfuncs);

void ComposerFactory::initialize() 
{
