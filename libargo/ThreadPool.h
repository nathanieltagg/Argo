...
// Taken from https://github.com/nbsdx/ThreadPool
// Then switched to fork which fixes deadlocks: https://github.com/domgho/ThreadPool2
...
/**
 *  Simple ThreadPool that creates `_thread_count` threads upon its creation,
