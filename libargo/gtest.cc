...
int main(int argc, char **argv)
{
  ...
  composer.set_output_callback(&progress);
...
//"/home/argo/test_files/PhysicsRun-2015_10_21_1_25_15-0003469-01047_20161123T115249_bnb_20161123T153248_merged.root";
 "/Users/tagg/PhysicsRun-2016_5_10_15_21_12-0006234-00031_20160802T075516_ext_unbiased_20160802T110203_merged_20160802T121639_reco1_20160802T144807_reco2_20171030T150606_reco1_20171030T162925_reco2.root";
  ...
  for(int iter=0;iter<1;iter++){
    ...
    // Output_t result = composer.compose(request);

    
    Output_t result = composer.satisfy_request(request);
    if(!result) std::cerr << "gtest Composer returned null result." << std::endl;
    ...
    final_result = result;
    std::cout << "WTF.... result is " << ((result)?"ok":"null") << std::endl;
    std::cout << "WTF.... final_result is " << ((final_result)?"ok":"null") << std::endl;
  }
  if(!final_result) std::cerr << "gtest Composer returned null final_result." << std::endl;
