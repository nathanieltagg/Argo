...
Geometry.prototype.yzToTransverse = function(plane,y,z)
{
  switch(plane) {
    case 0: return this.kU[0]*z + this.kU[1]*y; 
    case 1: return this.kV[0]*z + this.kV[1]*y;
    case 2: return z;
  }
}
...
Geometry.prototype.transvserseToWire = function(plane,trans)
{
  return (_transverse_plane_offset[plane]+trans)*3.333333;
  // switch(plane) {
  //   case 0: return 337.50194+trans*(3.33332); // wire*0.3
  //   case 1: return 332.16920+trans*(3.33333);
...
{
  return _transverse_plane_offset[plane];
}

// Geometry.prototype.wireToTransverse = function(plane,wire)
// {
//     return  (trans-_transverse_plane_offset[plane])*(3.33332);
// }
