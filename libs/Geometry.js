...
function OpDetGeo ()
{
  ...
  { opdet: 0 ,  x: -141.487 ,    y:55.249  , z:108.693  , type: 'pmt'},
  { opdet: 1 ,  x: -141.342 ,    y:55.249  , z:149.287  , type: 'pmt'},
  { opdet: 2 ,  x: -141.380 ,    y:27.431  , z:72.034   , type: 'pmt'},
  { opdet: 3 ,  x: -141.387 ,    y:-0.303  , z:194.676  , type: 'pmt'},
  { opdet: 4 ,  x: -141.098 ,    y:-28.576 , z:71.407   , type: 'pmt'},
  { opdet: 5 ,  x: -141.183 ,    y:-56.615 , z:108.802  , type: 'pmt'},
  { opdet: 6 ,  x: -141.2239,    y:-56.203 , z:149.112  , type: 'pmt'},
  { opdet: 7 ,  x: -141.363 ,    y:54.646  , z:308.909  , type: 'pmt'},
  { opdet: 8 ,  x: -141.132 ,    y:54.693  , z:349.145  , type: 'pmt'},
  { opdet: 9 ,  x: -141.096 ,    y:-0.829  , z:262.947  , type: 'pmt'},
  { opdet: 10,  x: -141.031 ,    y:-0.706  , z:394.771  , type: 'pmt'},
  { opdet: 11,  x: -140.953 ,    y:-56.261 , z:308.572  , type: 'pmt'},
  { opdet: 12,  x: -140.594 ,    y:-57.022 , z:349.273  , type: 'pmt'},
  { opdet: 13,  x: -140.929 ,    y:55.771  , z:521.066  , type: 'pmt'},
  { opdet: 14,  x: -140.819 ,    y:55.822  , z:561.862  , type: 'pmt'},
  { opdet: 15,  x: -140.564 ,    y:-0.875  , z:474.028  , type: 'pmt'},
  { opdet: 16,  x: -140.597 ,    y:-0.549  , z:606.217  , type: 'pmt'},
  { opdet: 17,  x: -140.540 ,    y:-56.323 , z:521.153  , type: 'pmt'},
  { opdet: 18,  x: -140.566 ,    y:-56.205 , z:561.549  , type: 'pmt'},
  { opdet: 19,  x: -140.607 ,    y:55.800  , z:732.006  , type: 'pmt'},
  { opdet: 20,  x: -140.486 ,    y:55.625  , z:772.816  , type: 'pmt'},
  { opdet: 21,  x: -140.570 ,    y:-0.051  , z:685.136  , type: 'pmt'},
  { opdet: 22,  x: -140.250 ,    y:-0.502  , z:817.141  , type: 'pmt'},
  { opdet: 23,  x: -140.558 ,    y:-56.408 , z:732.207  , type: 'pmt'},
  { opdet: 24,  x: -140.550 ,    y:-56.284 , z:772.838  , type: 'pmt'},
  { opdet: 25,  x: -139.780 ,    y:55.822  , z:931.998  , type: 'pmt'},
  { opdet: 26,  x: -139.587 ,    y:55.313  , z:972.794  , type: 'pmt'},
  { opdet: 27,  x: -139.363 ,    y:27.607  , z:1010.644 , type: 'pmt'},
  { opdet: 28,  x: -140.122 ,    y:-0.722  , z:886.531  , type: 'pmt'},
  { opdet: 29,  x: -139.400 ,    y:-28.625 , z:1011.288 , type: 'pmt'},
  { opdet: 30,  x: -140.004 ,    y:-56.309 , z:932.872  , type: 'pmt'},
  { opdet: 31,  x: -139.721 ,    y:-56.514 , z:972.797  , type: 'pmt'},
    // paddles. Need to deal specifically.
  { opdet: 32,  x:-161.341  ,    y:-28.201 + 20/2*2.54, z: 287.161, type: 'paddle'},
  { opdet: 33,  x:-160.858  ,    y:-27.994 + 20/2*2.54, z: 498.501, type: 'paddle'},
  { opdet: 34,  x:-160.882  ,    y:-28.100 + 20/2*2.54, z: 583.333, type: 'paddle'},
  { opdet: 35,  x:-160.654  ,    y:-27.755 + 20/2*2.54, z: 794.575, type: 'paddle'}
